...
int main()
{
 ...
 //Os espaços alocados correspondem a:
    ...
    /* | *(int *)(pBuffer ...) esta pegando o VALOR que o ponteiro aponta e ele tem que fazer
        O cast (int *) por que eh o um ponteiro void, não eh um tipo definido
         Primeiro o (int*) faz o cast de void* para int*, em seguida o primeiro * derreferencia 
         o ponteiro para poder atribuir o valor*/

  *(int *)pBuffer = 0; //PQ ELE INICIALIZA COM 0 E FAZ CASTING COM INT
  for (;;)
  {
    ...
    printf("8)Quick Sort\n");
    printf("9)Sair\n");
    scanf("%d", (int *)(pBuffer + (3 * sizeof(int))));//colocando o valor digitado no endereço de 
                                                        //memória apontado pelo ponteiro seguindo o calculo do sizeof
                                                        // que anda pelos espaços alocados
